...
export const getAllHistory = createAction('[History] Get All History', props<{
  startDate: Date;
  endDate: Date;
}>());
...
export const deleteHistoryVideoSuccess = createAction('[History] Delete History Video Success', props<{
  videoId: string
}>());
export const deleteHistoryVideoFailure = createAction('[History] Delete History Video Failure', props<{
  error: any
}>());
